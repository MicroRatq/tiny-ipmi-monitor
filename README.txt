...
This project collects local hardware telemetry on Windows and forwards it to a USB HID telemetry endpoint.
It is designed for ESP32-based companion firmware that exposes a vendor-defined HID interface, while the host
application gathers sensor data through LibreHardwareMonitor.
